...
namespace Cinema.MVC.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FavoriteGenre,Id,Name,Age")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("FavoriteGenre,Id,Name,Age")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
